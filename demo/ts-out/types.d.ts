...
export interface TriangleVertex { x: number; y: number; u: number; v: number; w: number; }
export interface TextureInfo { id: number; width: number; height: number; }
export interface LayerInfo { id: number; visible: boolean; opacity: number; blendMode: BlendMode; clip: Rect | null; }
export interface FontInfo { id: number; size: number; }
...
export interface CameraConfig { x: number; y: number; width: number; height: number; zoom: number; rotation: number; }
...
export interface WasmRasterEngine {
    ...
    draw_triangle_filled(x0: number, y0: number, u0: number, v0: number, w0: number, x1: number, y1: number, u1: number, v1: number, w1: number, x2: number, y2: number, u2: number, v2: number, w2: number, r: number, g: number, b: number, a: number, use_texture: boolean, texture_id: number, use_perspective: boolean, msaa: boolean): void;
...
export declare type Mat4 = Float64Array;
