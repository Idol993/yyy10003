...
export { initWasm, getWasm, createImageData, createUint8View, writeBytesToWasm, freeWasmBytes, writeFloatArrayToWasm } from './wasm-bridge';
export { MatrixStack, mat4Create, mat4Identity, mat4Multiply, mat4Translate, mat4Scale, mat4RotateZ, mat4Ortho, mat4TransformPoint, mat4Clone } from './matrix';
...
export {
  ...
  WasmExports, WasmRasterEngine, Mat4
} from './types';
